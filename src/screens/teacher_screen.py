...
def teacher_dashboard():
    ...
    with c2:
        st.markdown(
            f"<h5 style='margin-bottom:0px; padding-bottom:0px;text-align:right;'>Welcome, {teacher_data['name']}</h5>",
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='jagrutipatil123')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='Jagruti Patil')
